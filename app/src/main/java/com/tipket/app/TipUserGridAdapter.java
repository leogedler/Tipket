 ...
 */
class TipUserGridAdapter extends BaseAdapter {
    private Context context;
    private final List<ParseObject> userProducts;
    protected Format mDateFormat;

    ImageView imageView;

    public TipUserGridAdapter(Context context, List<ParseObject> userProducts) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LayoutInflater inflater = (LayoutInflater) context
            ...
            gridView = inflater.inflate(R.layout.tip_user_grid, parent, false);
        ...
        // set image
        imageView = (ImageView) gridView.findViewById(R.id.productUserView2);

        final ParseObject product = userProducts.get(position);
