...
public class UserProfile extends ListActivity {
    ...
    protected View mUserProfileHeaderView;
    protected URL mUrl;
    protected ImageView mInviteFacebookFriends;
    protected String mCurrentUserName;
    protected boolean mGallerySelected;
    protected ImageView mGalleryIconUnSelected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = ProgressDialog.show(UserProfile.this, "", getString(R.string.loading_label));
        mUserProfileHeaderView = getLayoutInflater().inflate(R.layout.user_profile_header, null);

        //Receiving the user's data
        mUserName = getIntent().getExtras().getString("userName");
        mUserId = getIntent().getExtras().getString("userId");
        mGallerySelected = getIntent().getExtras().getBoolean("gallerySelected");
        mCurrentUserName = ParseUser.getCurrentUser().getUsername();


        mCountOfFollowings = (TextView) mUserProfileHeaderView.findViewById(R.id.countOfFollowings);

        //Go to user profile gallery view
        mGalleryIconUnSelected = (ImageView) mUserProfileHeaderView.findViewById(R.id.galleryUnselected);
        mGalleryIconUnSelected.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if (mUserId.equals(ParseUser.getCurrentUser().getObjectId())) {
                    ...
                    Intent intent = new Intent(UserProfile.this, UserProfile2.class);
        ...
        mUserNameView = (TextView) mUserProfileHeaderView.findViewById(R.id.userNameView);
        mUserNameView.setText(mUserName);
        mUserScore = (TextView) mUserProfileHeaderView.findViewById(R.id.userScore);
        ...
        userQuery.getInBackground(mUserId, new GetCallback<ParseUser>() {
            ...
            public void done(ParseUser parseUser, ParseException e) {
                ...
                if (e != null) {
                    ...
                    Log.d("Error fetching parse user", e.getMessage());
                    ...
                    mUserProfilePictureView = (ImageView) mUserProfileHeaderView.findViewById(R.id.userProfilePicture);
                    try {
                        mUrl = new URL("https://graph.facebook.com/"+mFacebookId+"/picture?type=large&return_ssl_resources=1");
                    } catch (MalformedURLException exception) {
                        exception.printStackTrace();
                    }
                    Picasso.with(UserProfile.this).load(String.valueOf(mUrl)).fit().transform(new RoundedTransformation(180, 0))
                                ...
                                if (mProducts.size() != 0){
                                    ...
                                    if (mViewStop == false) {
                                        ...
                                        if (getListView().getAdapter() == null) {
                                            ...
                                            getListView().addHeaderView(mUserProfileHeaderView, null, false);

                                            TipUserAdapter adapter = new TipUserAdapter(getListView().getContext(), mProducts);
                                            setListAdapter(adapter);

                                            progressDialog.dismiss();
                                        } else {
                                            // refill the adapter!
                                            ((TipUserAdapter) getListView().getAdapter()).refill(mProducts);
        ...
        mFollowButton = (ImageView) mUserProfileHeaderView.findViewById(R.id.followButton);
        mUnfollowButton = (ImageView) mUserProfileHeaderView.findViewById(R.id.unfollowButton);
        mFollowingButton = (TextView) mUserProfileHeaderView.findViewById(R.id.followingButton);
        mLogoutButton = (ImageView) mUserProfileHeaderView.findViewById(R.id.logOutButton);
        mInviteFacebookFriends = (ImageView) mUserProfileHeaderView.findViewById(R.id.inviteFacebookFriends);
                    ...
                    if (ParseFacebookUtils.getSession() != null) {
                        ...
                        builder.setPositiveButton(R.string.go_to_sign_up_with_facebook, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Intent intent = new Intent(UserProfile.this, PreLaunchActivity.class);
                                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
                            }
                ...
                mCurrentUser.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        ...
                        if (e == null) {
                            ...
                            Toast.makeText(UserProfile.this, R.string.following_added, Toast.LENGTH_LONG).show();
                ...
                mCurrentUser.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        ...
                        if (e == null) {
                            ...
                            Toast.makeText(UserProfile.this, R.string.following_removed, Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_tip) {
            ...
            builder.setPositiveButton(R.string.yes_label, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent intent = new Intent(UserProfile.this, TipInPlaceActivity.class);
                    startActivity(intent);
            ...
            builder.setNegativeButton(R.string.no_label, new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    Intent intent = new Intent(UserProfile.this, TipNotInPlaceActivity.class);
                    startActivity(intent);
        ...
        if (id == R.id.user_profile){
            ...
            intent.putExtra("userName", mCurrentUserName);
            intent.putExtra("userId", actualUserId);
            intent.putExtra("gallerySelected", true);
            startActivity(intent);
                    ...
                    public void onComplete(Bundle values,
                        ...
                        if (error != null) {
                            if (error instanceof FacebookOperationCanceledException) {
                                Toast.makeText(UserProfile.this.getApplicationContext(),
