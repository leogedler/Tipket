 ...
 */
public class FollowingAdapter extends ArrayAdapter<ParseUser> {
    ...
    public FollowingAdapter (Context context, List<ParseUser> users) {
        super(context, R.layout.following_item, users);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.following_item, null);
